...
@Component({
  ...
  template: `
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
      ...
      <p-card styleClass="shadow-sm h-full">
        <ng-template pTemplate="content">
          <label class="text-sm text-surface-500">Valor de la propiedad</label>
          <div class="text-xl font-semibold text-surface-900 mt-1">
      ...
      <p-card styleClass="shadow-sm h-full">
        <ng-template pTemplate="content">
          <label class="text-sm text-surface-500">Primera vivienda</label>
          <div class="text-xl font-semibold text-surface-900 mt-1">
      ...
      <p-card styleClass="shadow-sm h-full">
        <ng-template pTemplate="content">
          <label class="text-sm text-surface-500">Tipo de hipoteca</label>
